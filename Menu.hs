...
import Item (Item, salvarEstoque, carregarEstoque, adicionarItem, updateItem, deleteItem, listItems, getEstoque, setEstoque, getPreco, setPreco)
...
exibirMenu :: IORef [Item] -> IO ()
exibirMenu refEstoque = do
